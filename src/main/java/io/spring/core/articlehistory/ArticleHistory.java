...
public class ArticleHistory {
  ...
  public static ArticleHistory from(
      int revType,
      String id,
      String slug,
      String title,
    ...
    return new ArticleHistory(
        revType, userId, id, slug, title, description, body, tags, createdAt, updatedAt);
  }

  public ArticleHistoryData toData() {
    return new ArticleHistoryData(
        id,
        RevType.getName(revType),
        revisedAt,
        userId,
        articleId,
        slug,
